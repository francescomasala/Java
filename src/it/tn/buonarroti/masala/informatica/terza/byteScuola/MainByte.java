package it.tn.buonarroti.masala.informatica.terza.byteScuola;
...
public class MainByte {
	...
	public static void main(String[] args) {
		it.tn.buonarroti.masala.informatica.terza.byteScuola.Byte b = new it.tn.buonarroti.masala.informatica.terza.byteScuola.Byte();
